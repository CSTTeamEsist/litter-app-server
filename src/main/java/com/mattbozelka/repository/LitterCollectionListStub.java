...
public class LitterCollectionListStub implements LitterCollectionRepository {
	...
	public List<LitterCollection> getLitterCollectionList(){
		LitterCollection lc1 = new LitterCollection (111, 222, 333, 444, 7);
		LitterCollection lc2 = new LitterCollection (222, 333, 444, 555, 3);
		LitterCollection lc3 = new LitterCollection (333, 444, 555, 666, 4);
